...
def cargar_datos_prueba():
    juan_perez = {"contraseña": "1235JoJo", "nombre": "Juan", "apellido": "Perez", "sexo": "hombre", "edad": 34, "ubicacion": (1, 2), "intereses": ["hax", "sushi", "roirros", "troirros"], "likes": ["ciroluiro", "dio_brando"], "mensajes": {"ciroluiro": "nuinos", "dio_brando": "WRYYYYYYY"}}
    ...
    dio_brando = {"contraseña": "contraseña", "nombre": "Dio", "apellido": "Brando", "sexo": "hombre", "edad": 99, "ubicacion": (0, 0), "intereses":["hax", "sangre", "poder", "gatos", "relojes", "cuchillos"], "likes": ["ciroluiro", "matiasbaci", "lisa_lisa"], "mensajes": {"ciroluiro": "pedo", "matiasbaci": "caca"}}
