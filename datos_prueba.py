...
def cargar_datos_prueba():  #carga un diccionario que adentro tiene un diccionario para cada usuario. En la lista de intereses, hicimos que todos tuvieran "hax", de esta forma se puede obtener match con todos simplemente poniendo como interes "hax" al registrarse
    ...
    lisa_lisa = {"contraseña": "contraseña", "nombre": "Lisa", "apellido": "Lisa", "sexo": "mujer", "edad": 36, "ubicacion": (0, 0), "intereses": ["hax", "baño-de-inmersion", "bufandas", "lentes"], "likes": ["ciroluiro", "dio_brando", "matiasbaci"], "mensajes": {"ciroluiro": "nuinos", "dio_brando": "WRYYYYYYY", "matiasbaci": "holis"}}
    ...
    dio_brando = {"contraseña": "contraseña", "nombre": "Dio", "apellido": "Brando", "sexo": "hombre", "edad": 99, "ubicacion": (0, 0), "intereses":["hax", "sangre", "poder", "gatos", "relojes", "cuchillos"], "likes": ["ciroluiro", "matiasbaci", "lisa_lisa"], "mensajes": {"ciroluiro": "nuinos", "matiasbaci": "chauchis"}}
